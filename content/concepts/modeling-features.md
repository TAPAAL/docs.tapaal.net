...
See [Components in the editor](/modeling/components/) for the creation workflow. **Tools > Merge net components** creates a single component containing the selected model's elements.
