...
|------|--------|----------|---------|
| ![select](/gui/editor/icons/select.png?classes=inline)     | Select | Any      | S       |
| ![place](/gui/editor/icons/place.png?classes=inline)     | Place  | Any      | P   |
| ![transition](/gui/editor/icons/transition.png?classes=inline)     | Transition  | Any  | T   |
| ![urgent transition](/gui/editor/icons/urgent-transition.png?classes=inline)     | Urgent Transition | Timed | Y |
| ![Uncontrollable Transition](/gui/editor/icons/uncontrollable-transition.png?classes=inline)     | Uncontrollable Transition | Game | L |
| ![Uncontrollable Urgent Transition](/gui/editor/icons/uncontrollable-urgent-transition.png?classes=inline)     | Uncontrollable Urgent Transition | Game + Time | O |
| ![arc](/gui/editor/icons/arc.png?classes=inline)    | Arc    | Any | A |
| ![transport arc](/gui/editor/icons/transport-arc.png?classes=inline)    | Transport Arc | Timed | R |
| ![inhibitor arc](/gui/editor/icons/inhibitor-arc.png?classes=inline)     | Inhibitor Arc | Timed | I |
| ![annotation](/gui/editor/icons/annotation.png?classes=inline)     | Annotation/Note | Any | N |
...
![Edit place transition or arc](/gui/editor/edit.gif)
