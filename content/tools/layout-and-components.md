...
weight: 70
lastmod: 2026-08-29
description: Rearrange a net automatically and merge components while preserving a recoverable original.
---

**Tools > Automatic net layout** rearranges model elements to improve readability. Save the original file before applying it if hand-placed layout matters to your work.
